...
foreach ($tipos_muestra as $tm) {
    $html .= '<th style="border:1px solid #000; padding:4px; background-color:#6c5b7b; color:white; width: 30px; height: 80px;">';
    $html .= '<div style="font-weight:bold; white-space:nowrap; writing-mode: vertical-lr; transform: rotate(180deg); text-align:center; padding:10px 0; margin:0 auto; line-height:1;">' . $tm . '</div>';
    $html .= '</th>';
}
