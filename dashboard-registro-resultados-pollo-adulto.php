...
// Obtener lista de enfermedades ÚNICAS desde la base de datos
$enfermedadesQuery = "SELECT DISTINCT enfermedad FROM san_analisis_pollo_bb_adulto 
                      WHERE tipo_ave = 'ADULTO' AND estado = 'ANALIZADO' 
...
// Mapeo de nombres técnicos a nombres amigables para ADULTO
$columnLabels = [
    ...
    's05' => 'S5',
    's06' => 'S6',
    'count_muestras' => 'Muestras',
    'gmean' => 'Gmean',
    'desviacion_estandar' => 'SD',
    'cv' => 'CV'
];

// Obtener columnas relevantes para ADULTO
$columnNames = [];
...
if ($metaQuery) {
    ...
    foreach ($fieldInfo as $field) {
        ...
        if (
            !preg_match('/^t\d{2}$/', $fieldName) &&
            !in_array($fieldName, ['id_analisis', 'estado', 'numero_informe', 'fecha_informe', 'usuario_registro', 'fecha_solicitud', 'codigo_enfermedad', 'titulo_promedio'])
        ) {
...
// Encontrar el índice de la columna de fecha para el filtro
...
<head>
    ...
    <title>Resultados Cuantitativos - Pollo Adulto</title>
                                                ...
                                                if ($col === 'enfermedad' && $value !== '') {
                                                    ...
                                                    switch (strtoupper($value)) {
                                                        ...
                                                        case 'CAV':
                                                            ...
                                                            break;
                                                        case 'LT':
                                                            $nombreCompleto = 'LT : Laringotraqueitis';
                                                            break;
                                                        case 'MG':
                                                            $nombreCompleto = 'MG : Mycoplasma Gallisepticum';
                                                            break;
                                                        case 'MS':
                                                            $nombreCompleto = 'MS : Mycoplasma Synoviae';
                                                            break;
                                                    }
