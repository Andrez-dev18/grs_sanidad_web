...
<body class="bg-gray-50">
    ...
    `;
            ...
            async function loadData(year) {
                ...
                console.log(year);
                try {
                    const enviosData = (await (await fetch(`${base}/envios-por-mes.php${qs}`)).json()).data;
                    const estadoData = (await (await fetch(`${base}/estado-solicitudes.php${qs}`)).json()).data;
                    const cuantData = (await (await fetch(`${base}/solicitudes-cuantitativas.php${qs}`)).json()).data;
                    const cualiData = (await (await fetch(`${base}/solicitudes-cualitativas.php${qs}`)).json()).data;
                    const muestrasData = (await (await fetch(`${base}/top-muestras.php${qs}`)).json()).data;
                    const analisisData = (await (await fetch(`${base}/top-analisis.php${qs}`)).json()).data;
