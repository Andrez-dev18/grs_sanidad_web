...
function md2html($md, &$toc) {
    ...
    foreach ($lines as $line) {
        ...
        if (preg_match('/^# (.+)$/', $trimmed, $m)) {
            ...
            $id = slug($m[1]); $tit = $m[1];
            $secIcons = [
                'conceptos-del-modulo' => 'fa-lightbulb', 'configuracion-previa' => 'fa-cog',
                'registro' => 'fa-vial', 'listado' => 'fa-list', 'seguimiento' => 'fa-chart-line'
            ];
    ...
    $html = implode("\n", $out);
    /* Iconos alineados con dashboard-reportes.php y dashboard-seguimiento.php */
    $icons = [
        '[i:eye]' => '<i class="fas fa-eye text-blue-600" title="Detalles"></i>',
...
<body>
    <div class="guia-layout">
        ...
        <nav class="guia-nav" id="guiaNav">
            ...
            <?php
            $navIcons = ['conceptos-del-modulo' => 'fa-lightbulb', 'configuracion-previa' => 'fa-cog', 'registro' => 'fa-vial', 'listado' => 'fa-list', 'seguimiento' => 'fa-chart-line'];
            foreach ($toc as $item):
        ...
        <div class="guia-wrap">
            <div class="guia-toolbar">
                <a href="generar_guia_muestras_pdf.php" target="_blank" rel="noopener" class="guia-btn-pdf">
                    <i class="fa-solid fa-file-pdf"></i> Descargar PDF
                </a>
            </div>
            <?= $html ?>
            <p class="guia-footer"><i class="fas fa-info-circle"></i> Guía del Sistema de Sanidad — Módulo Muestras</p>
        </div>
    </div>
    <script>
    (function() {
