...
function md2html($md, &$toc) {
    ...
    foreach ($lines as $line) {
        ...
        if (preg_match('/^# (.+)$/', $trimmed, $m)) {
            ...
            $id = slug($m[1]); $tit = $m[1];
            $secIcons = [
                'conceptos-del-modulo' => 'fa-lightbulb', 'ingreso-de-resultados' => 'fa-atom',
                'flujo' => 'fa-project-diagram'
            ];
    ...
    $icons = [
        ...
        '[i:paperclip]' => '<i class="fa-solid fa-paperclip text-slate-600" title="Documentos"></i>',
        '[i:plus]' => '<i class="fa-solid fa-plus text-emerald-600" title="Agregar"></i>',
    ];
    ...
    $btns = [
        ...
        '[btn:guardar-resultados]' => '<span class="guia-btn guia-btn-primary"><i class="fas fa-save"></i> Guardar Resultados</span>',
    ...
    $links = [
        'resultados' => ['modules/registro_laboratorio/dashboard-rpta-laboratorio.php', '🧪 Resultados de Laboratorio', 'Registro de la respuesta del laboratorio', '3.1 Resultados de Laboratorio'],
        ...
        'config-tipo-respuesta' => ['modules/configuracion/tipo_respuesta/dashboard-respuesta.php', '🛠️ Tipos de respuesta', '7.6', '7.6 Tipos de respuesta'],
        'registro-muestras' => ['modules/registro_muestra/dashboard-registro-muestras.php', '📋 Registro de Muestras', 'Registro del pedido de muestra', '2.1 Registro de Muestras'],
    ];
...
<body>
    <div class="guia-layout">
        ...
        <nav class="guia-nav" id="guiaNav">
            ...
            <?php
            $navIcons = ['conceptos-del-modulo' => 'fa-lightbulb', 'ingreso-de-resultados' => 'fa-atom', 'flujo' => 'fa-project-diagram'];
            foreach ($toc as $item):
        ...
        <div class="guia-wrap">
            <?= $html ?>
            <p class="guia-footer"><i class="fas fa-info-circle"></i> Guía del Sistema de Sanidad — Módulo Laboratorio</p>
        </div>
    </div>
    <script>
    (function() {
