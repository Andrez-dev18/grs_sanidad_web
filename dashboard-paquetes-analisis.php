...
<head>
    ...
    <title>Dashboard - Paquetes de Análisis</title>
...
<body class="bg-gray-50">
    <div class="container mx-auto px-6 py-12">
        ...
        <!-- VISTA PAQUETES DE ANÁLISIS -->
        <div id="viewPaqueteAnalisis" class="content-view">
            <div class="content-header max-w-7xl mx-auto mb-8">
                <div class="flex items-center gap-3 mb-2">
                    <span class="text-4xl">📦</span>
                    <h1 class="text-3xl font-bold text-gray-800">Paquetes de Análisis</h1>
                </div>
                <p class="text-gray-600 text-sm">Administre los paquetes de análisis registrados en el sistema</p>
            </div>
            ...
            <div class="form-container max-w-7xl mx-auto">
                ...
                <div class="mb-6 flex justify-between items-center flex-wrap gap-3">
                    <button type="button" 
                            ...
                            onclick="exportarPaquetesAnalisis()" 
                    ...
                    <button type="button" 
                            ...
                            onclick="openPaqueteAnalisisModal('create')">
                        ➕ Nuevo Paquete
                    </button>
                </div>
                    ...
                    <table class="data-table w-full">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-sm font-semibold text-gray-800">Nombre del Paquete</th>
                        ...
                        <tbody id="paqueteAnalisisTableBody" class="divide-y divide-gray-200">
                            <?php
                            $query = "SELECT pa.codigo, pa.nombre, pa.tipoMuestra, tm.nombre as tipo_muestra_nombre 
                                     FROM com_paquetes_analisis pa
                                     LEFT JOIN com_tipo_muestra tm ON pa.tipoMuestra = tm.codigo
                                     ORDER BY pa.codigo";
                            ...
                            if ($result && mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo '<td class="px-6 py-4 text-gray-600">' . htmlspecialchars($row['tipo_muestra_nombre'] ?? 'Sin tipo') . '</td>';
                                    echo '<td class="px-6 py-4 flex gap-2">
                                        <button class="btn-icon p-2 text-lg hover:bg-blue-100 rounded-lg transition" 
                                                title="Editar" 
                                                onclick="openPaqueteAnalisisModal(\'edit\', ' . (int)$row['codigo'] . ', \'' . 
                                        ...
                                        <button class="btn-icon p-2 text-lg hover:bg-red-100 rounded-lg transition" 
                                                title="Eliminar" 
                                                onclick="confirmPaqueteAnalisisDelete(' . (int)$row['codigo'] . ')">
                                            🗑️
                                        </button>
                                    </td>';
                                    echo '</tr>';
                                ...
                                echo '<tr>';
                                echo '<td colspan="4" class="px-6 py-8 text-center text-gray-500">No hay paquetes de análisis registrados</td>';
                                echo '</tr>';
                            }
                            ?>
                        </tbody>
        ...
        <div id="paqueteAnalisisModal" style="display: none;" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div class="bg-white rounded-2xl shadow-lg w-full max-w-md">
                <!-- Modal Header -->
                <div class="flex items-center justify-between p-6 border-b border-gray-200">
                    <h2 id="paqueteAnalisisModalTitle" class="text-xl font-bold text-gray-800">➕ Nuevo Paquete de Análisis</h2>
                    <button onclick="closePaqueteAnalisisModal()" class="text-gray-500 hover:text-gray-700 text-2xl leading-none transition">
                        ×
                    </button>
                </div>
                ...
                <div class="p-6">
                    <form id="paqueteAnalisisForm" onsubmit="return savePaqueteAnalisis(event)">
                        ...
                        <div class="form-field mb-6">
                            ...
                            <select 
                                id="paqueteAnalisisModalTipoMuestra" 
                                name="tipoMuestra" 
                                required
                            ...
                            >
                                ...
                                <?php
                                $query_tipos = "SELECT codigo, nombre FROM com_tipo_muestra ORDER BY nombre";
                        ...
                        <div class="flex flex-col-reverse sm:flex-row gap-3 justify-end">
                            <button 
                                type="button" 
                                onclick="closePaqueteAnalisisModal()"
