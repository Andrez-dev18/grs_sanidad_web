...
<body class="bg-gray-50">
    ...
    <script>
        ...
        function guardarConfiguracionCorreo(e) {
            ...
            fetch('api_mantenimiento/correo_config.php', {
                method: 'POST',
        ...
        function cargarContactos() {
            fetch('api_mantenimiento/contactos_crud.php?action=list')
                .then(r => r.json())
                .then(data => {
        ...
        function guardarContacto(e) {
            ...
            fetch('api_mantenimiento/contactos_crud.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
        ...
        document.addEventListener('DOMContentLoaded', () => {
            fetch('api_mantenimiento/correo_config.php?action=get')
                .then(r => r.json())
                .then(data => {
                    if (data.correo) {
